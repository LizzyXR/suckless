...
static char dmenufont[]             = "Hack Nerd Font Mono:size=16"; // "monospace:size=16";
static const char *fonts[]          = { /*"monospace:size=10",*/ "Hack Nerd Font Mono:size=13", "Noto Color Emoji:size=14:antialias=true:autohint=true" };
...
static const char *dmenucmd[] = { "dmenu_run", "-b", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, "-p", "Search:", NULL };
...
/* script launch bindings */
	...
	{ MODKEY|ControlMask,	XK_v,	   spawn,		{.v = (const char*[]){ "imgcliphist", "sel", NULL } } },
	{ MODKEY|ControlMask,	XK_c,	   spawn,		{.v = (const char*[]){ "imgcliphist", "add", NULL } } },
	{ MODKEY|ShiftMask,		XK_a,      spawn,       {.v = (const char*[]){ "rip", NULL } } },
	{ MODKEY|ControlMask,	XK_a,      spawn,       {.v = (const char*[]){ "dmenuaudioswitch", NULL } } },
	{ MODKEY|ShiftMask,		XK_d,      spawn,       {.v = (const char*[]){ "define", NULL } } },
	{ MODKEY,				XK_r,      spawn,       {.v = (const char*[]){ "rec", NULL } } },
	{ MODKEY|ShiftMask,		XK_grave,  spawn,       {.v = (const char*[]){ "dmenuvids", NULL } } },
	...
	{ MODKEY,				XK_F2,     spawn,       {.v = (const char*[]){ "sys", NULL } } },
...
/* other bindings */
	...
	{ MODKEY|ShiftMask,				XK_Tab,    		spawn,		SHCMD("layouttoggle") },
	{ MODKEY,						XK_F3,     		spawn,      SHCMD("pactl load-module module-loopback latency_msec=70 && dunstify 'Mic loopback enabled'") },
    { MODKEY|ShiftMask,				XK_F3,     		spawn,      SHCMD("pactl unload-module module-loopback && dunstify 'Mic loopback disabled'") },
	{ MODKEY|ControlMask|ShiftMask, XK_backslash, 	spawn, 		SHCMD("~/scripts/pywal16") },
};
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,	Button3,	spawn,          SHCMD("st -e nvim ~/.local/src/dwmblocks-async/config.h") },
