...
static char dmenufont[]				  = "Hack Nerd Font Mono:size=16"
//static char dmenufont[]             = "monospace:size=16";
static const char *fonts[]          = { /*"monospace:size=16",*/ "Hack Nerd Font Mono:size=16", "Noto Color Emoji:size=14:antialias=true:autohint=true"  };
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,	Button1,	spawn,          SHCMD("st -e nvim ~/.local/src/dwmblocks/blocks.h") },
