...
alias einde="flatpak update && yay -Syyuu --noconfirm && systemctl poweroff"
alias noteinde="flatpak update && yay -Syyuu --noconfirm && systemctl reboot"
alias freeswap="sudo swapoff -a && sudo swapon -a && echo 'done!'"
alias venv="source ~/Coding/Python/venv/bin/activate"

alias ff="fastfetch"
alias src="cd ~/.local/src/"
alias lb="cd ~/.local/bin"
alias ngdir="cd /usr/share/nginx"
